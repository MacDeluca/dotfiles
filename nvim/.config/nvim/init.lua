-- brew install --cask cognominal/neovim-nightly.fork/neovim-nightly
...
local packages = {
	...
	{ src = "https://github.com/nvim-treesitter/nvim-treesitter.git", version = "master", name = "nvim-treesitter" },
...
require("nvim-treesitter.configs").setup({
	ensure_installed = { "lua", "typescript", "javascript", "tsx", "json", "html", "css", "bash", "markdown", "jsdoc" },
	sync_install = true,
	auto_install = true,
	highlight = {
		enable = true,
